# Contributing to LearningBadges

Love LearningBadges and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/SuEric/LearningBadges/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/LearningBadges.git
   # Navigate to the newly cloned directory
   cd LearningBadges
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/SuEric/LearningBadges.git
   ```
...
owners to license your work under the terms of the [MIT License](https://github.com/SuEric/LearningBadges/blob/master/LICENSE.md).
